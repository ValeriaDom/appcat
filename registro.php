          ...
          <div class="text-center col-sm-8 col-sm-offset-2">
            <form  method="POST" action="inicio.php">
              <div class="form-group">
                    <label for="exampleInputName2">Nozmbre</label><br>
                    <input type="text" class="text-center col-sm-8 col-sm-offset-2" id="exampleInputName2" placeholder="Nombre">
              </div>
              <div class="form-group">
                     <label for="exampleInputPassword1">Contraseña</label><br>
                     <input type="password" class="text-center col-sm-8 col-sm-offset-2" id="exampleInputPassword1" placeholder="Contraseña">
              </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Correo Electronico</label> <br>
                    <input type="email" class="text-center col-sm-8 col-sm-offset-2" id="exampleInputEmail" placeholder="Correo Electronico">
                </div>
                <div class="form-group">
                      <label for="exampleInputName2">Empresa</label><br>
                      <input type="text" class="text-center col-sm-8 col-sm-offset-2" id="exampleInputName2" placeholder="Empresa">
                </div><br>
